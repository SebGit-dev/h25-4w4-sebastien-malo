...
function genere_vague($couleur_haut, $couleur_bas){?>
    <svg class="waveFooter" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 300" style="background-color: <?php echo $couleur_haut ?>;">
